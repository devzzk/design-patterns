...
use Behavioral\Specification\Specifications\AndSpecification;
use Behavioral\Specification\Specifications\NotSpecification;
use Behavioral\Specification\Specifications\OrSpecification;
use Behavioral\Specification\Specifications\PriceSpecification;
...
class SpecificationTest extends TestCase
{
    ...
    public function testCanAnd()
    {
        ...
        $this->assertTrue($andSpec->isSatisfiedBy(new Item(90)));
    }
}